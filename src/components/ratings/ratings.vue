<template>
	<div class="ratings" ref="ratings">
		<div class="ratings-content">
		  ...
		  <!--复用组件，分割线和选择类型-->
		  <v-split></v-split>
      <v-ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="ratings" v-on:ratingtypeSelect="ratingtypeSelect" v-on:contentToggle="contentToggle"></v-ratingselect>
        ...
        <div class="no-rating" v-show="!ratings || !ratings.length">暂无更多内容</div>
      </div>
		</div>
	</div>
</template>
